...
export default function DirectorCaseAnalytics() {
    ...
    async function loadMetrics(showRefresh = false) {
        try {
            ...
            const response =
                await directorApi.getCaseAnalytics();
    ...
    const data = useMemo(() => {
        return STATUS_ORDER.map((status) => ({
            status: status.label,
            key: status.key,
            count: getValue(metrics, status.key),
            color: status.color,
        }));
    }, [metrics]);
                    ...
                    <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        <div className="flex items-center justify-between gap-5 sm:justify-end">
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-xl font-bold tracking-[-0.03em] text-[#101a28]">
                                    {loading
                                        ? "..."
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-xl font-bold tracking-[-0.03em] text-[#527eb9]">
                                    {loading
                                        ? "..."
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-xl font-bold tracking-[-0.03em] text-[#3d9b7a]">
                                    {loading
                                        ? "..."
                    ...
                    <div className="border-b border-slate-100 p-5 lg:border-b-0 lg:border-r sm:p-6">
                        ...
                        <div className="mt-5 border-t border-slate-100 pt-5">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex h-9 min-w-9 items-center justify-center rounded-lg bg-[#fdf0f0] px-2 text-xs font-bold text-[#c65b5b]">
                                    {loading
                                        ? "..."
