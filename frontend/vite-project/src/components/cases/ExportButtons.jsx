  ...
  return (
    <div className="min-h-full bg-slate-50/70">
      ...
      <main className="ps-container space-y-7 pb-12">
          ...
          <div className="flex flex-col gap-5 border-b border-slate-200 pb-6 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-2 max-w-xl text-sm leading-6 text-slate-500">
                Review previously handled cases and monitor your support
                activity.
              </p>
            ...
            <div className="flex shrink-0 items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-lg font-semibold tracking-[-0.025em] text-slate-950">
        ...
        <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          ...
          {statCards.map(
            ({
              ...
              <div
                key={label}
                className="group relative rounded-[20px] border border-slate-200/80 bg-white p-5 shadow-[0_6px_22px_rgba(15,35,65,0.04)] transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_10px_28px_rgba(15,35,65,0.065)]"
              >
        ...
        <section className="overflow-hidden rounded-[22px] border border-slate-200/80 bg-white shadow-[0_6px_26px_rgba(15,35,65,0.04)]">
          ...
          <div className="flex min-h-[46px] items-center justify-between border-b border-slate-100 bg-slate-50/40 px-6 sm:px-7">
