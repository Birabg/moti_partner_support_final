    ...
    */
    ...
    return (
        <>
            ...
            {/* Drawer */}
            <aside className="fixed right-0 top-0 z-50 flex h-screen w-full max-w-[680px] flex-col overflow-hidden bg-slate-50 shadow-2xl">
                                                ...
                                                >
                                                    ...
                                                    {url && (
                                                        <a
                                                            ...
                                                            target="_blank"
                                                            rel="noreferrer"
                                                            className="shrink-0 rounded-lg bg-slate-900 px-3 py-2 text-xs font-semibold text-white transition hover:bg-slate-800"
                                                        >
                                                            View
                                                        </a>
                                                    )}
