...
export default function RecentCasesTable({
    ...
    return (
        ...
        >
            {/* HEADER STRIP */}
            <div className="flex items-center justify-between border-b border-slate-100 bg-slate-50/40 px-6 py-3">
            ...
            {cases.length === 0 ? (
                ...
                <>
                    ...
                    >
                        ...
                        <Link
                            to="/admin/cases"
                            className="group/link inline-flex items-center gap-2 text-xs font-semibold text-blue-600 transition hover:text-blue-700"
                        >
                            View latest support activity

                            <FaArrowRight className="text-[10px] transition-transform group-hover/link:translate-x-0.5" />
                        </Link>
